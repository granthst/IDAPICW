...
def CreatePartialReconstructions(aBasis, aMean, componentMags):
    ...
    for i in range(0,aBasis.shape[0]+1):
...
# otherwise some files may be over-written! E.g. comment out then run, then uncomment and run againimageData = array(ReadImages())
